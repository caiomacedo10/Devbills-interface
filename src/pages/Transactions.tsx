...
const Transactions = () => {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: dependencies são intencionalmente limitadas a month e year
  useEffect(() => {
    fetchtransactions();
                  ...
                  <tr key={transaction.id} className="hover:bg-gray-800">
                    ...
                    <td className="px-3 py-4 text-sm text-gray-400 whitespace-nowrap">
                      {transaction.category ? (
                        ...
                        <span className="text-sm italic text-gray-500">Sem categoria</span>
                      )}
                    </td>
                    ...
                    <td className="px-3 py-4 text-sm text-gray-400 whitespace-nowrap">
                      <span
                        className={`${
                          transaction.type === "income" ? "text-primary-500" : "text-red-500"
                        }`}
                      >
