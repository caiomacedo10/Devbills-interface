      ...
      <div className="container-app">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Gerencie suas contas de forma simples e rápida com o{" "}
          ...
          <div className="container-app">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature) => (
                <div key={feature.title} className="bg-gray-800 p-6 rounder-xl shadow-lg">
        ...
        <section className="py-12 md:py-20">
          <div className="bg-gray-900 p-8 md:p-12 rounded-xl text-center border border-gray-700">
            <h2 className="text-2xl md:text-3x1 font-bold text-white mb-4">
